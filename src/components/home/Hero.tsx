...
import { ArrowRight, ChevronDown, Layers, Compass, CheckCircle2, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-zinc-950 via-zinc-950/92 to-zinc-950/75" />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center w-full">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            {/* Eyebrow badge */}
            <motion.div
              className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 mb-6"
            ...
            {/* Main Headline */}
            <motion.h1
              className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-black tracking-tight leading-[1.08] mb-6 text-white"
            ...
            {/* Subtitle */}
            <motion.p
              className="text-lg sm:text-xl text-zinc-300 leading-relaxed mb-8 max-w-xl font-normal"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <span className="block mt-2 text-zinc-400 text-base sm:text-lg">
            ...
            >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-3 px-8 sm:px-9 py-8 rounded-sm font-bold text-base sm:text-lg leading-normal whitespace-nowrap bg-zinc-900 text-white border border-zinc-700 hover:bg-zinc-800 transition-all duration-200 hover:-translate-y-0.5 shadow-md active:scale-95"
              >
            ...
            >
              {[
                ...
                <div
                  key={item.label}
                  className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-zinc-900/90 border border-zinc-800 text-xs sm:text-sm font-semibold text-zinc-200 shadow-sm whitespace-nowrap"
                >
          ...
          >
            <div className="w-full max-w-[480px] rounded-3xl overflow-hidden bg-zinc-900 border border-zinc-700/80 shadow-2xl relative">
              {/* Interactive Tabs */}
              <div className="p-2.5 bg-zinc-950/80 border-b border-zinc-800 flex items-center gap-1.5 overflow-x-auto">
                {previewModes.map((mode, idx) => (
                  <button
                    key={mode.id}
                    onClick={() => setActiveTab(idx)}
                    className={`flex-1 py-2 px-3 rounded-xl text-xs sm:text-sm font-bold transition-all text-center whitespace-nowrap ${activeTab === idx
              ...
              <div className="relative h-64 sm:h-72 w-full overflow-hidden bg-black">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {/* Tag badge */}
                    <div className="absolute top-4 left-4 px-3 py-1 rounded-full text-xs font-bold bg-black/80 backdrop-blur-md border border-amber-500/40 text-amber-400">
                      {currentPreview.badge}
                    </div>

                    {/* Metric pill */}
                    <div className="absolute bottom-4 right-4 px-3 py-1.5 rounded-xl text-xs font-bold bg-zinc-900/90 backdrop-blur-md border border-zinc-700 text-white flex items-center gap-2">
              ...
              <div className="p-6 sm:p-7 bg-zinc-900">
                ...
                {/* Link to 3D showcase */}
                <div className="mt-5 pt-4 flex items-center justify-between border-t border-zinc-800/60">
