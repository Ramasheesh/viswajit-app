...
export const metadata: Metadata = { title: "Privacy Policy | Bright spark  Electrical & Lighting" };
    ...
    <div className="min-h-screen" style={{ paddingTop: "80px", background: "var(--background)" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
          <p>Bright spark  Electrical & Lighting values your privacy. This policy explains how we collect, use and protect your personal information when you use our website or services.</p>
          ...
          <p>For any privacy-related queries, contact us at info@Bright spark electrical.com</p>
        </div>
      </div>
    </div>
  );
