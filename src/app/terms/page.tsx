...
export const metadata: Metadata = { title: "Terms of Service | Bright spark  Electrical & Lighting" };
    ...
    <div className="min-h-screen" style={{ paddingTop: "80px", background: "var(--background)" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20">
        ...
        <div className="space-y-6 text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
          <p>By using the Bright spark  Electrical & Lighting website, you agree to these terms. Our services are provided subject to the following conditions.</p>
          ...
          <p>2D drawings and 3D visualizations produced by Bright spark  Electrical & Lighting remain our intellectual property until full payment is received.</p>
          ...
          <p>For questions about these terms, contact info@Bright spark electrical.com</p>
        </div>
      </div>
    </div>
  );
